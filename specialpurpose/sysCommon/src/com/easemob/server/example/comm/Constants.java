...
public interface Constants {
    ...
    // ORG_ADMIN_USERNAME
    public static String ORG_ADMIN_USERNAME = PropertiesUtils.getProperties().getProperty("lihongsheng");
    // ORG_ADMIN_PASSWORD
    public static String ORG_ADMIN_PASSWORD = PropertiesUtils.getProperties().getProperty("5230528");
	// DEFAULT_PASSWORD
