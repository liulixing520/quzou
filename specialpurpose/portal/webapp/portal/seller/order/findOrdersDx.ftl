...
<div class="content my_account">
	<h2 class="title" style='font-size:20px'>分销订单</h2>
	<div class="search_area">
       ...
       <div class="listheight">
          ...
          <#list orderList as orderHeader>
            ...
            <#assign supplierSaleTotalMap =dispatcher.runSync("getSupplierSaleTotalMap", Static["org.ofbiz.base.util.UtilMisc"].toMap("orderHeader", orderHeader, "userLogin", userLogin))/>
            ...
            <tr valign="middle"<#if alt_row> class="alternate-row"</#if>>
              ...
              <td>
              	 <#assign store = orh.getProductStore()?if_exists>
              	 ${store.storeName!}
              </td>
              <td><#if supplierSaleTotalMap??>${supplierSaleTotalMap.yjSaleTotal!0}</#if></td>
               <td>
