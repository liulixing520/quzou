...
.nav-tabs li.current a{background:#b3d9ff; color:#000; font-weight:bold;}
	...
	$(function(){
		...
		$(".breadcrumb").append("<li class='active'>报表管理</li><li class='active'>购物车弃购产品</li>")
        ...
        $("#Pagination").pagination("3", {
         ...
         <div class="rtab-warp" id="newGuideTarget2" style="padding-left:15px; padding-top:5px;"> 
          <ul class="nav-tabs" style="padding-top:10px; padding-bottom:20px; border:none;"> 
           <li id="li1"> <a class="blue" href="/portal/control/shoppingCartOutHistoryHTML"> <span id="shelfProductNum"> 報表頁面&nbsp; </span> </a> </li> 
           <li> <a class="blue" href="/portal/control/shoppingCartOutHistoryPdf"> <span id="auditFailProductNum"> 导出pdf&nbsp;</span> </a> </li> 
           <li>  <a class="blue" href="/portal/control/shoppingCartOutHistory.xls"> <span id="downShelfProductNum"> 导出EXCEL&nbsp;</span> </a> </li> 
          </ul> 
        ...
        <#-- <div class="page-content"> 
          <div class="screenlet-title-bar" style="font-size:14px; color:#555; font-weight:bold;">
             <a class="blue" href="/portal/control/shoppingCartOutHistoryHTML">HTML</a>
             <br class="clear" />
          </div>
          <div class="screenlet-title-bar" style="font-size:14px; color:#555; font-weight:bold;">
             <a class="blue" href="/portal/control/shoppingCartOutHistoryPdf">导出pdf</a>
             <br class="clear" />
          </div> 
          <div class="screenlet-title-bar" style="font-size:14px; color:#555; font-weight:bold;">
             <a class="blue" href="/portal/control/shoppingCartOutHistory.xls">导出EXCEL</a>
             <br class="clear" />
          </div>
             ...
             <div> 
              ...
              <table cellspacing="0" class="basic-table hover-bar"> 
               <tbody> 
                ...
                <#if shoppingCartOutHistoryList?has_content>
                    <#list shoppingCartOutHistoryList as shlo>
                 
	                <tr> 
	                 <td class="center"><label class="position-relative"> 
	                 <input type="checkbox" class="ace" /> <span class="lbl"></span> </label> </td> 
	                 <td>${shlo.internalName!}</td> 
	                 <td class="hidden-480">${shlo.modifiedPrice!}</td> 
	                 <td>${shlo.fromDate!}</td> 
	                 <td>${shlo.firstName!}${shlo.lastName!}</td> 
	                 <td class="hidden-480">${shlo.quantity!}</td>               
	                </tr> 
                    </#list>
                </#if>
