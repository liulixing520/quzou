...
function submitFormDisableSubmits(form) {
 ...
 $(function(){ 
		$(".breadcrumb").append("<li class='active'>网站管理</li><li class='active'>超级特卖设置</li><li class='active'>商品列表</li>")
		...
		$("#orderStatus2").val("${orderStatusId!}");
		setpage("${viewIndex}","${orderListSize}","${viewSize}","setpage");
	});
</script>
...
<div class="page-content">
    <div class="page-content-area">
        	<div id="navcontainer">
			<ul id="navlist">
			<li id="active_1" onclick="getTagId(this.id);"><a href="<@ofbizUrl>mng_Home_SuperDealsProducts</@ofbizUrl>" _fcksavedurl="#" >添加特卖商品</a></li>
			<li id="active_2" onclick="getTagId(this.id);"><a href="<@ofbizUrl>mng_SuperDealsList</@ofbizUrl>" _fcksavedurl="#" >查看超级特卖</a></li>
			</ul>
			</div><br/>

        <div class="row">
            <div class="col-xs-12">
                <form class="form-horizontal" role="form" method="post" action="<@ofbizUrl>mng_FindSuperDealsByOne</@ofbizUrl>">
                    <div class="form-group" style="float:left;">
                        <label class="col-sm-2 control-label no-padding-right" style="width:100px; padding-top:10px;">商品名称</label>

                        <div class="col-sm-9" style="width:400px;">
                            <input class="col-xs-10 col-sm-5" type="text" id="internalName" style="width:250px; margin-top:5px;" name="internalName" placeholder="输入商品名称进行查询……" value="${(internalName)!}">
                    ...
                    <div id="sample-table-2_wrapper" class="dataTables_wrapper form-inline no-footer">
                        <table id="sample-table-2"
                            ...
                            <tbody>
						        ...
						        <#list orderHeaderList as productcategorymemberList>
                                    <td align="center" style="text-align:center;vertical-align:inherit;">
                                      ${productcategorymemberList.productId?if_exists}
                                    </td>
                                    <td align="center" style="text-align:center;vertical-align:inherit;">
                                      ${productcategorymemberList.internalName?if_exists}
                                    </td>
                                    <td align="center" style="text-align:center;vertical-align:inherit;">
                                      ${productcategorymemberList.productNameZh?if_exists}
                                    </td>

                                     <td style="text-align:center;vertical-align:inherit;">
                                     <div class="hidden-sm hidden-xs action-buttons" style="text-align:center;vertical-align:inherit;">
                                     <a class="green" href="<@ofbizUrl>mng_addSuperDealsToHomePage</@ofbizUrl>?productId=${(productcategorymemberList.productId)!}" title="添加"> <i class="ace-icon fa fa-pencil bigger-130"></i> </a>
                                     </div>
                                    </td>
                                </tr>
                                </#list>
