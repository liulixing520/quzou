...
-->
    ...
    <div class="screenlet">
      ...
      <div class="screenlet-body">
        <#assign firstChar = "*">
        <form ction="<@ofbizUrl>/genericAllCode</@ofbizUrl>" method='post' id='entityForm'>
        <table class="basic-table hover-bar" cellspacing='0'>
          ...
          <#list entitiesList as entity>
            ...
            <#assign anchor="">
            <td class="button-col">
             <input type='checkbox' name='selectEntityName' value='${entity.entityName}'/>
             <a href='<@ofbizUrl>ViewCodeSetJeasy?entityName=${entity.entityName}</@ofbizUrl>' target='_blank'>代码生成</a>
             <!-- <a href='<@ofbizUrl>ViewCodeSet?entityName=${entity.entityName}</@ofbizUrl>'>dwz</a>-->
