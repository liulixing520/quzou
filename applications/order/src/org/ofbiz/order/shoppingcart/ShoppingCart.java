...
public class ShoppingCart implements Iterable<ShoppingCartItem>, Serializable {
    ...
    //2014-12-27
    protected Map<String,Object> addParams = FastMap.newInstance();

    
    public void setAddParams(String key,Object value){
    	addParams.put(key, value);
    }
    public Object getAddParams(String key){
    	if(addParams.containsKey(key)){
    		return addParams.get(key);
    	}else{
    		return null;
    	}
    }
    //add  by wangyg
    protected String dxStoreId = null;
    public String getDxStoreId() {
        return this.dxStoreId;
    }
    public void setDxStoreId(String dxStoreId) {
        this.dxStoreId = dxStoreId;
    }
    ...
    public ShoppingCart(ShoppingCart cart) {
        ...
        this.dxStoreId = cart.getDxStoreId();
    }
...
//    protected String billFromVendorPartyId = null;
  //  protected String shipFromVendorPartyId = null;
    ...
    public Map<String, Object> makeCartMap(LocalDispatcher dispatcher, boolean explodeItems) {
        ...
        //add by wangyg 代销
        result.put("dxStoreId", this.getDxStoreId());
        return result;
    }
