...
public class EasemobChatGroups {
    ...
    public static void main(String[] args) {
		...
		dataObjectNode.put("groupname", "yxck测试群组");
		dataObjectNode.put("desc", "yxck测试群组yxck测试群组");
		dataObjectNode.put("public", true);
		dataObjectNode.put("maxusers", 1000);
		dataObjectNode.put("approval", false);
		dataObjectNode.put("owner", "cdd");
...
//		arrayNode.add("xiaojianguo003");
         ...
         * -H 'Authorization: Bearer {token}'
         */
		String toDelChatgroupid = "1430896661399183";
         ...
         * -H 'Authorization: Bearer {token}'
		String addToChatgroupid = "143089257491129";
		String toAddUsername = "lhs";
         ...
         * -H 'Authorization: Bearer {token}'
		String delFromChatgroupid = "143089257491129";
		String toRemoveUsername = "xyb";
		...
		String toAddBacthChatgroupid = "143089257491129";
		ArrayNode usernames = JsonNodeFactory.instance.arrayNode();
		usernames.add("88888888888");
		usernames.add("xyb");
...
//    	ArrayNode arrayNode = JsonNodeFactory.instance.arrayNode();
//    	System.out.println(creteGroup("会议测试", "huiyuicewshi", true, "1000", false, "cdd", arrayNode));
//    	System.out.println(addGroupUser("1430896661399183", "lhs"));
	}
