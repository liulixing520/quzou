        ...
        <div class="aut-postatta" id="rgPostatta"> 
         ...
         <div class="autpost-con clearfix"> 
          <div class="autopost-lf"> 
           ...
           <span class="upimgcon"> <span class="uploadingimg"> <img alt="" src="<#if legpoidContent?has_content><@ofbizUrl>img?imgId=${(legpoidContent.dataResourceId)!}</@ofbizUrl></#if>" id="show_url_1" /> <var class="rg-fangda"></var> </span> </span>
           <#-- 
         ...
         <div class="autpost-con clearfix"> 
          <div class="autopost-lf">
           ...
           <span class="upimgcon"> <span class="uploadingimg"> <img alt="" src="<#if legpoidContent?has_content><@ofbizUrl>img?imgId=${(legpoidContent.dataResourceId)!}</@ofbizUrl></#if>" id="show_url_2" /> <var class="rg-fangda"></var> </span> </span>
           <#-- 
           <form method="post" enctype="multipart/form-data" action="<@ofbizUrl>upCertificateContentForPerson</@ofbizUrl>"> 
           	<div class="uploading-btn">
        		<input type="hidden" name="partyId" value="${(userLogin.partyId)!}"/>
         ...
         <#-- <span><input type="button" class="smallSubmit" value="返回" /></span><#-- onclick="savePartyGroup();" --> 
         </div> 
