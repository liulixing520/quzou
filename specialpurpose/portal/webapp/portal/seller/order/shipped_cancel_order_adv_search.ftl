...
<div class="pageContent">
   ...
   <form action="FindCancelShippedOrder" name='FindCancelShippedOrderdiv'  id='FindCancelShippedOrderdiv' method="post"  class="single_table" >
...
<div class="formBar">
<ul>
				<li><a  href="#" onclick="javascript:submitForm('FindCancelShippedOrderdiv');" class="button"><span>${uiLabelMap.CommonFind}</span></a></li>
