...
/*request.setAttribute("optProductCategoryId", null);
request.setAttribute("productCategoryId", null);*/
/*categoryText=request.getAttribute("categoryText");
context.categoryText=categoryText;*/
...
category = delegator.findOne("ProductCategory", [productCategoryId : categoryId], true);
if (category) {
