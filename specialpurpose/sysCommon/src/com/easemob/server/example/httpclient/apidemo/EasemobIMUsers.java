...
//        datanode.put("password", Constants.DEFAULT_PASSWORD);
        datanode.put("username","11111111111");
        datanode.put("password", "111111");
...
//        ObjectNode imUserLoginNode = imUserLogin(datanode.get("username").asText(), datanode.get("password").asText());
        ObjectNode imUserLoginNode = imUserLogin("1445631185568", "$SHA$FZaDqO1jYpECN.$AclxH-0HZXpPd94bdkqLeQGd_e4");
        ...
        if (null != deleteIMUserByUsernameBatchNode) {
            ...
            System.out.println("######"+deleteIMUserByUsernameBatchNode.toString());
        }
         */
    }
