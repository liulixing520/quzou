...
TEMP_VIEW_LOOP:
    ...
    public Map<String, ModelEntity> getEntityNoCache() throws GenericEntityException
    {
            synchronized (ModelReader.class) {
                // must check if null again as one of the blocked threads can still enter
                //if (entityCache == null) { // now it's safe
...
TEMP_VIEW_LOOP:
    ...
    public Set<String> getNoCacheEntityNames() throws GenericEntityException
	{
		Map<String, ModelEntity> ec = getEntityNoCache();
		if (ec == null)
		{
			throw new GenericEntityConfException("ERROR: Unable to load Entity Cache");
		}
