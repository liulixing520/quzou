...
<div class="detail-page">
   <div class="en-us">
           <div class="ui-breadcrumb"> 
  	        <a rel="nofollow" href="<@ofbizUrl>main</@ofbizUrl>"><font>${uiLabelMap.PortalHome}</font></a> <span class="divider"><font>&gt;${uiLabelMap.PortalHelp}</font></span>
           </div>
   </div>
			<#if helps?has_content>
			   ${StringUtil.wrapString(helps.longHelpInfo?if_exists)}
			</#if>  
</div>
