...
function submitFormDisableSubmits(form) {
 ...
 $(function(){ 
		$(".breadcrumb").append("<li class='active'>网站管理</li><li class='active'>推荐品类设置</li><li class='active'>商品列表</li>")
...
<div class="page-content">
    <div class="page-content-area">
        ...
        <div class="row">
            <div class="col-xs-12">
                <form class="form-horizontal" role="form" method="post" action="<@ofbizUrl>mng_FindCategoryMemberByOne</@ofbizUrl>">
                    <div class="form-group" style="float:left;">
                        <label class="col-sm-2 control-label no-padding-right" style="width:80px; padding-top:10px;">商品名称</label>
                            ...
                            <tbody>
						        ...
						        <#list orderHeaderList as productcategorymemberList>
                                    ...
                                    <td align="center" style="text-align:center;vertical-align:inherit;">
                                     ...
                                     <a class="green" href="<@ofbizUrl>mng_addCategoryMemberToHomePage</@ofbizUrl>?productId=${(productcategorymemberList.productId)!}" title="添加"> <i class="ace-icon fa fa-pencil bigger-130"></i> </a>
                                     </div>
                                    </td>
                                </tr>
                                </#list>
