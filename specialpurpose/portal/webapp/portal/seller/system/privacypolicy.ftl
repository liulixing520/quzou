...
<div class="detail-page">
   <div class="en-us">
           <div class="ui-breadcrumb"> 
  	        <a rel="nofollow" href="<@ofbizUrl>main</@ofbizUrl>"><font>${uiLabelMap.PortalHome}</font></a> <span class="divider"><font>&gt;${uiLabelMap.PortalPrivacyPolicy}</font></span>
           </div>
   </div>
			<#if privacypolicy?has_content>
			   ${StringUtil.wrapString(privacypolicy.longHelpInfo?if_exists)}
			</#if>  
</div>
