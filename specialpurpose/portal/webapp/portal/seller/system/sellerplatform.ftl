...
<div class="detail-page">
   <div class="en-us">
           <div class="ui-breadcrumb"> 
  	        <a rel="nofollow" href="<@ofbizUrl>main</@ofbizUrl>"><font>${uiLabelMap.PortalHome}</font></a> <span class="divider"><font>&gt;${uiLabelMap.PortalSellerPlatform}</font></span>
           </div>
   </div>
			<#if sellerplatform?has_content>
			   ${StringUtil.wrapString(sellerplatform.longHelpInfo?if_exists)}
			</#if>  
</div>
