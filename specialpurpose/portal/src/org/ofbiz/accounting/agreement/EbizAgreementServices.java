...
public class EbizAgreementServices {

    public static final String module = EbizAgreementServices.class.getName();
    ...
    /**
     * Determines commission receiving parties and amounts for the provided party, price, and quantity
     * @param ctx The DispatchContext that this service is operating in.
     * @param context Map containing the input parameters.
     * 		partyIdFrom String      Party Id
     *      partyIdTo   String      Party Id
     ...
     *              
     */
    public static Map<String, Object> getCommissionForParty(DispatchContext ctx, Map<String, Object> context) {
        ...
        try {
            ...
            List<GenericValue> agreementItems = delegator.findByAnd("AgreementItemAndAgreement", UtilMisc.toMap(
            		"partyIdFrom", partyIdFrom,
                    "partyIdTo", partyIdTo,
                    "agreementItemTypeId", "AGREEMENT_COMMISSION"), null, true);
            
            if(UtilValidate.isEmpty(agreementItems)){
            	agreementItems = delegator.findByAnd("AgreementItemAndAgreement", UtilMisc.toMap(
                		"partyIdFrom", "Company",
                        "partyIdTo", partyIdTo,
                        "agreementItemTypeId", "AGREEMENT_COMMISSION"), null, true);
            }
