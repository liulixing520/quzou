...
#right{float:left; width:auto; padding-left:15px;}          
  ...
  <script type="text/javascript">
     $(function(){ 
		$(".breadcrumb").append("<li class='active'>身份认证</li><li class='active'>个体户认证</li>")
       ...
       <div class="authenticn-cat">
        ...
        <#-- 
         ...
         <div class="autpost-con"> 
          <span class="marg-r9"> <input type="text" class="textinpt" style="padding:0;" value="${officeSiteName!}" id="inputvalue_1" must="1" name="inputvalue" onblur="setInput(1);" maxlength="150" /> <input type="hidden" name="tcIdentityId" id="tcIdentityId_1" value="1" /> </span> 
         ...
         <div class="autpost-con"> 
          <span class="marg-r9"> <input type="text" class="textinpt" style="padding:0;" value="${groupName!}" id="inputvalue_2" must="1" name="inputvalue" onblur="setInput(2);" maxlength="50" /> <input type="hidden" name="tcIdentityId" id="tcIdentityId_2" value="2" /> </span> 
         ...
         <div class="autpost-con clearfix"> 
          ...
          <span class="marg-r9"> <input type="text" class="textinpt" style="padding:0;" name="inputvalue" value="${barCode!}" id="inputvalue_3" must="1" onblur="setInput(3);" maxlength="50" /> </span> 
         ...
         <div class="autpost-tit"> 
          ...
          <!--					<a id="shili_4" class="prodoct-name-button" href="http://image.tradeease.com/dhs/mos/image/micidentity/20140818/p2.jpg"  target="_blank" >查看示例</a>
				--> &nbsp; 
         </div> 
         <div class="autpost-con clearfix"> 
          <!--       ----------------       是文字内容还是图片内容--> 
          <!--<a style="display:none"  target="_blank" class="prodoct-name-button" href="http://image.tradeease.com/image/micidentity.png" id="show_url_4" ></a>--> 
          <!--  修改 start --> 
        ...
        <b>请填写下面信息：</b>
         ...
         <div class="autpost-con02 clearfix" style="margin-bottom:50px; margin-left:366px;"> 
          <span><input type="button" class="smallSubmit" value="提交认证资料" onclick="savePartyGroup();" /></span> 
         </div> 
        </div> 
