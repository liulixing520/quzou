                ...
                ajax.request(url, {
                    ...
                    'onsuccess': function (r) {
                        try {
                            ...
                            if (json.state == 'SUCCESS') {
                            	/*WuHK修改多图片路径问题*/
                            	$.each(json.list,function(i,obj1){
                            		var webappIdx = obj1.url.indexOf("webapp");
                            		if(webappIdx!=-1){
                            			obj1.url = "http://192.168.1.153:80"+obj1.url.substring(webappIdx+6);
                            		}else{
                            			obj1.url = "http://192.168.1.153:80"+obj1.url;
                            		}
                            	});
