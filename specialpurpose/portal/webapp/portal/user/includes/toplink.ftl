    ...
    <div class="header_top">
        <div class="header_top_inner">
            ...
            <div class="search_box">
                <#--<input class="text" placeholder="搜索" id="search_key" type="text">
                <input class="btn" id="search_key_btn" style="cursor: default;" type="text">-->
                    ...
                    <div class="header_myhome">
	                	<a href="#" class="myhome_a">我的物美<span></span></a>
	                  	<div class="myhome_slide" style="display: none;">
	                        <ul>
	                            <li><a href="<@ofbizUrl>userMain</@ofbizUrl>">我的物美</a></li>
	                            <li><a href="<@ofbizUrl>user_myorder</@ofbizUrl>">我的订单</a></li>
	                            <li><a href="<@ofbizUrl>user_listAddress</@ofbizUrl>">收货地址</a></li>
