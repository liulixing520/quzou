...
<div class="pageContent">
   ...
   <form action="FindProcessingOrder" name='FindProcessingOrderdiv'  id='FindProcessingOrderdiv' method="post"  class="single_table" >
...
<div class="formBar">
<ul>
				<li><a  href="#" onclick="javascript:submitForm('FindProcessingOrderdiv');" class="button"><span>${uiLabelMap.CommonFind}</span></a></li>
