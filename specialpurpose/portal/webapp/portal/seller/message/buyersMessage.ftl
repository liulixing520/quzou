...
<div class="content">
            ...
            <div class="col-main">
                <div class="col-main-warp">
						<div id="right"><!-- 修改 start -->
						  <form name="searchMsgForm" id="searchMsgForm" action="/messageweb/newmessagecenter.do?msgtype=001,002,003&amp;dhpath=10005,0301,51001" method="post" autocomplete="off" 360chrome_form_autofill="2">
						  <input name="dhpath" id="dhpath" type="hidden" value="10005,0301,51001">
						  ...
						  <div class="page-topic clearfix"><h2>买家消息</h2></div>
						   <div class="page-operate-tip inb-packup">
							...
							<div class="rtab-warp">
								<ul class="clearfix">
									<li class="current"><a onclick="handleTab('001,002,003');" href="javascript:handleTab('001,002,003');"><span>全部  </span></a></li>
									<li><a onclick="handleTab('001');" href="javascript:handleTab('001');"><span>询盘  </span></a></li>
									<li><a onclick="handleTab('002');" href="javascript:handleTab('002');"><span>订单  </span></a></li>
									<li><a onclick="handleTab('003');" href="javascript:handleTab('003');"><span>其它 </span></a></li>
								</ul>
							</div>
							<div class="inb-searchwarp clearfix">
								<div class="inb-searchbox">
									<span>关键词：</span>
																		<input id="inbInput" style="-ms-ime-mode: disabled;" type="text" maxlength="200" value="输入订单编号或者联系人" dataval="输入订单编号或者联系人">
																	</div>
											...
											<tr>
												...
												<td class="inb-smtype">类 型</td>
																								<td class="inb-smreplay" style="cursor: pointer;">回复数<var class="inb-narr"></var></td>
																																				<td class="inb-smtime" style="cursor: pointer;">最后回复时间<var class="inb-narr"></var></td>
																							</tr>
										</thead>
										<tbody>
											    											    											                                				    																							
											<tr>
												<td class="inb-smcheck"><input name="topicid" type="checkbox" value="288548082"></td>
																																				<td title="已读" class="inb-smstatus hasread" topicid="288548082"><span></span></td>
																																																<td class="inb-smmark" topicid="288548082"><span></span></td>
																																																	<td class="inb-smlink">sunvsoft090909</td>
																								    																							<td class="inb-smsubject"><a style="cursor: pointer;" href="/messageweb/loadmessagedetail.do?messageid=288548082&amp;dhpath=10005,0301,51001" target="_blank">PO#1465459197</a></td>
    																																			<td class="inb-smtype">订单</td>
																																				<td class="inb-smreplay"><em>0</em></td>
																																				<td class="inb-smtime">2014-10-11 14:43</td>
											</tr>												
																					</tbody>
									</table>
																	</div>
	    ...
	    function gotopage (pagenum, frm) {
			...
			frm.submit();
                    ...
                    <span class="pageleft"><span>共有1条记录，每页显示20条</span></span>
