package org.ofbiz.thirdparty.alipay.config;
...
public class AlipayConfig {
	...
	public AlipayConfig(){
		...
		try {
			GenericValue payment =delegator.findOne("PaymentGateway", UtilMisc.toMap("baseId","Alipay"),false);
			this.ALIPAY_GATEWAY_NEW=payment.getString("paymentUrl");
			...
			this.sign_type=payment.getString("paymentEncodeType");
