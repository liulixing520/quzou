...
<table width="100%" border="1" cellpadding="0" cellspacing="0"
	...
	$(function(){
		...
		-->
		$(".breadcrumb").html("<li><i class='ace-icon fa fa-home home-icon'></i><a href='/portal/control/sellerIndex'>首页</a></li><li class='active'>报表管理</li><li class='active'>商品销售额列表</li>")
         ...
         <div class="page-content" style="border:1px solid #ccc;margin:15px; margin-top:5px;"> 
          <div class="page-content-area"> 
           <div class="page-header" style="padding-bottom:5px; height:50px"> 
            <h1 style="padding-top:15px; font-size:18px; float:left;">商品销售金额列表</h1>
            <a class="smallSubmit" style="float:right; margin-top:5px;" href="<@ofbizUrl>MySalesAmountGoodsReport.xls</@ofbizUrl>">导出EXCEL</a> 
           </div>
           <div class="row" > 
            <div class="col-xs-12"> 
              ...
              <table cellspacing="0" class="basic-table hover-bar"> 
               <tbody> 
                <tr class="header-row-2"> 
                 ...
                 <td><a class="sort-order" href="">销售总金额</a></td>
                ...
                <#if mySalseAmountGoods?has_content>
                	<#list mySalseAmountGoods as product>
                	...
                	<tr> 
                 		...
                 		<td><@ofbizCurrency amount=product.unitPrice isoCode="USD" /></td> 
                 		<td class="hidden-480">${product.totalQuantity!}</td>
                 		<td><@ofbizCurrency amount=product.totalPrice isoCode="USD" /></td> 
