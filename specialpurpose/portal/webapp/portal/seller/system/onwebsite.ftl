...
<div class="detail-page">
   <div class="en-us">
           <div class="ui-breadcrumb"> 
  	        <a rel="nofollow" href="<@ofbizUrl>main</@ofbizUrl>"><font>${uiLabelMap.PortalHome}</font></a> <span class="divider"><font>&gt;${uiLabelMap.PortalOnSite}</font></span>
           </div>
   </div>
			<#if onwebsite?has_content>
			   ${StringUtil.wrapString(onwebsite.longHelpInfo?if_exists)}
			</#if>  
</div>
