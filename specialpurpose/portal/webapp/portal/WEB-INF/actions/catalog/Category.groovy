...
int catLevel = CategoryLevelWorker.getCatLevel(request,productCategoryId);
context.catLevel = catLevel;
if(catLevel == 1){
	detailScreen = "categoryFirst";
}else if(catLevel == 2){
	detailScreen = "categorySecond";
	
}else{
	detailScreen = "categoryThird";
}

prodCatWithLevel = CategoryLevelWorker.getProductCategoryWithLevel(request,productCategoryId);
context.prodCatWithLevel = prodCatWithLevel;
