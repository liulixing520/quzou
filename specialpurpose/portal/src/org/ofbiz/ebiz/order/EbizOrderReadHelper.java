...
public class EbizOrderReadHelper extends OrderReadHelper{

	
	public EbizOrderReadHelper(GenericValue orderHeader) {
        super(orderHeader);
    }
	 ...
	 * @return
	 */
	public static EbizOrderReadHelper getEbizHelper(GenericValue orderHeader) {
        return new EbizOrderReadHelper(orderHeader);
    }
