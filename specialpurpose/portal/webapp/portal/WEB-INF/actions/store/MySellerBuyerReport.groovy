...
/*	  condList = FastList.newInstance();
	    ...
	    condList = FastList.newInstance();
	    condList.add(EntityCondition.makeCondition("productStoreId", EntityOperator.EQUALS, productStoreId2));
	    brandCond = EntityCondition.makeCondition(condList, EntityOperator.AND);
	    mySellerBuyerList = delegator.findList("OrderHeaderAndRoleSummary2", brandCond, null,null, null, false);
	    if(mySellerBuyerList){
	    	birtParameters = [:];
	    	birtParameters.mySellerBuyerList=mySellerBuyerList;
