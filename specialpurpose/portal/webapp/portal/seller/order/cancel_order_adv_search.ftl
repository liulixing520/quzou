...
<div class="pageContent">
   ...
   <form action="FindCreatedOrder" name='FindCreatedOrderdiv'  id='FindCreatedOrderdiv' method="post"  class="single_table" >
   ...
   <tr class='background_tr'>
    ...
    <tr class='background_tr'>
	<input name='orderStatusId' type='hidden' value='ORDER_CANCELLED'>
    <tr class='background_tr'>
...
<div class="formBar">
<ul>
				<li><a  href="#" onclick="javascript:submitForm('FindCreatedOrderdiv');" class="button"><span>${uiLabelMap.CommonFind}</span></a></li>
