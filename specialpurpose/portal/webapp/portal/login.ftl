...
<div class="page" style="margin-top:20px;margin-bottom:-40px;min-height:499px;">
    <form method="post" action="<@ofbizUrl>login</@ofbizUrl>" name="loginform">
        ...
        <div class="form-head" style="height:55px;">
            ...
            <h2 style="margin-bottom:10px; line-height:30px; line-height:50px\\9; float:left;">${uiLabelMap.PortalLogin}</h2>

            <div style="padding-top:22px;">${uiLabelMap.PortalJoin0}？<a
                    href="/portal/control/newcustomer">${uiLabelMap.PortalRegister}</a></div>
        </div>
