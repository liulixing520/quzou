...
#right{float:left; width:auto; padding-left:6px;}         
  ...
  <script type="text/javascript">
   $(function(){ 
		$(".breadcrumb").append("<li class='active'>身份认证</li><li class='active'>公司认证</li>")
        ...
        <#-- 
         ...
         <div class="autpost-con clearfix"> 
          <div class="autopost-lf">
           ...
           <!--<div class="uploading-btn"><span class="tourBtn"><input type="button" value="上传" onclick='popuUpload(4)' id='button_4'></span></div>-->
