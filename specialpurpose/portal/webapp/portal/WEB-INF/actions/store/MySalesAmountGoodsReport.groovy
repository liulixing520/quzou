...
/*	  condList = FastList.newInstance();
	    ...
	    brandCond = EntityCondition.makeCondition(condList, EntityOperator.AND);
	    mySalseAmountGoods = delegator.findList("SalesAmountGoods", brandCond, null,null, null, false);
	    if(mySalseAmountGoods){
	    	birtParameters = [:];
	    	birtParameters.mySalseAmountGoods=mySalseAmountGoods;
