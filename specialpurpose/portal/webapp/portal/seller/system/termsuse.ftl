...
<div class="detail-page">
   <div class="en-us">
           <div class="ui-breadcrumb"> 
  	        <a rel="nofollow" href="<@ofbizUrl>main</@ofbizUrl>"><font>${uiLabelMap.PortalHome}</font></a> <span class="divider"><font>&gt;${uiLabelMap.PortalTermsOfUse}</font></span>
           </div>
   </div>
			<#if termsuse?has_content>
			   ${StringUtil.wrapString(termsuse.longHelpInfo?if_exists)}
			</#if>  
</div>
