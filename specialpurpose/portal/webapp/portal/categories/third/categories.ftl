      ...
      <div id="refine-category">
        <div id="refine-category-list">
          <dl class="category-list">
            <dt class="cate-title"> <font style="text-decoration: underline;"></font> </dt>
            <dd class="list-box">
              <dl class="son-category">
                <dt class="sn-parent-title"> <a href=""> <span class="back-icon"> <font> &lt; </font> </span> <font>${uiLabelMap.PortalGlobalSpeedSoldTypeCf}</font> </a> </dt>
                <dd class="list-box">
                  <dl class="son-category">
                  <#if prodCatWithLevel?has_content>
                    ...
                    <dd>
                      <dl class="son-category">
                        ...
                        <dt class="sn-parent-title"> <span class="current-cate"> <font>   
                        <#-- ${catInfo!} -->
                        <#if catInfo?length gt 64>
					  	${(catInfo[0..80])?if_exists}..
					  	<#else>
					  	${(catInfo)!}
					  	</#if>
                        </font> </span> </dt>
 ...
 -->
     ...
     <#--   左侧广告  -->
       <#-- <div id="refine-shopping-guide-banner"> <a href=""> <img src="/portal/images/list-shopping-guide-banner.png"> </a> </div>
      <div id="refine-shopping-guide-banner"> <a href=""> <img src="/portal/images/list-shopping-guide-banner.png"> </a> </div>
     -->
