...
function submitFormDisableSubmits(form) {
 ...
 $(function(){ 
		$(".breadcrumb").append("<li class='active'>网站管理</li><li class='active'>推荐卖家设置</li><li class='active'>店铺列表</li>")
	}); 
</script>
<style type="text/css">
            ...
            <div class="col-xs-12">
                <form class="form-horizontal" role="form" method="post" action="<@ofbizUrl>mng_FindProductStoreByOne</@ofbizUrl>">
                    <div class="form-group" style="float:left;">
                        <label class="col-sm-2 control-label no-padding-right" style="width:100px; padding-top:10px;">店铺名称</label>
                    ...
                    <div id="sample-table-2_wrapper" class="dataTables_wrapper form-inline no-footer">
                        <table id="sample-table-2"
                            ...
                            <tbody>
						        ...
						        <#list orderHeaderList as productStore>
                                    <td align="center" style="text-align:center;vertical-align:inherit;">
                                     <#if (productStore.storeName)!?length gt 30>${(productStore.storeName[0..30])?if_exists}..<#else>${productStore.storeName?if_exists}</#if>
                                    </td>
                                    <td align="center" style="text-align:center;vertical-align:inherit;">
                                     <#if (productStore.title)!?length gt 30>${(productStore.title[0..30])?if_exists}..<#else>${productStore.title?if_exists}</#if>
                                    </td>
                                     <td style="text-align:center;vertical-align:inherit;">
                                     <div class="hidden-sm hidden-xs action-buttons" style="text-align:center;vertical-align:inherit;">
                                     <a class="green" href="<@ofbizUrl>mng_addStoreToHomePage</@ofbizUrl>?productStoreId=${(productStore.productStoreId)!}" title="添加"> <i class="ace-icon fa fa-pencil bigger-130"></i> </a>
                                     </div>
                                    </td>
                                </tr>
                                </#list>
