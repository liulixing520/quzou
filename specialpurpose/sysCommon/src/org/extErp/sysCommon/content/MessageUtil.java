...
public class MessageUtil{
	public static final String module = MessageUtil.class.getName();
	//need i18n
 ...
 public static void returnAjaxInfo(Map  outputMap, Map<String, ? extends Object> context) {
	 outputMap.put("navTabId", MessageUtil.notEmpt(context.get("navTabId")));
	 outputMap.put("callbackType", MessageUtil.notEmpt(context.get("callbackType")));
    }
