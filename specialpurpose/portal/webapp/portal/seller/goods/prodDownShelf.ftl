...
charset=utf-8" /> 
  <title>下架的产品 </title>
    <script type="text/javascript"> 
	 $(function(){ 
		$(".breadcrumb").append("<li class='active'>管理产品</li><li class='active'>已下架的产品</li>")
	});   
</script>  
 
  <!--<script type="text/javascript" 

src="http://seller.E岸通.com/js/publish/menu-

common_20111226.js"></script>--> 
...
href="http://www.dhresource.com/dhs/mos/css/stockingmanagement/

stockingsyipop.css?version=2014-10-13" rel="stylesheet" 
      ...
      <div id="right"> 
        ...
        <div class="col-sailtips clearfix"> 
         ...
         <div class="rightcol-tip"> 
          <p id="hideTipsBox" class="addheight"> 1.您添加的产品需要通过审 核后才能上架交易，审核时间通常在24-28个小时之内，遇特殊情况会稍有 延迟，敬请谅解<br />
              2.请核对您添加的产品是否 符合<a href="http://edu.TradeEase.com/s65201d426c7deedbe040007f010020ec.h

tml" target="_blank" class="lkundeline">商城网产品发布规则</a>， 不符合规则的产品将不能通过审核<br /> 3.现在起您发布的上架产品 都能够展示在店铺中了！同时还能设置加载搜索产品，获取更多曝光率！<a href="http://help.E岸通.com/E岸通/sellerhelpcn.php?
...
" id="viewTips">展开</span> 
        ...
        <form action="<@ofbizUrl>prodDownShelf</@ofbizUrl>" method="post"> 
...
--> 
        ...
        <div class="rtab-warp" id="newGuideTarget2"> 
         <ul class="nav nav-tabs" style="padding-top:10px; padding-bottom:10px;"> 
          ...
          <li class="current"> <a href="<@ofbizUrl>prodDownShelf</@ofbizUrl>"> <span id="downShelfProductNum"> 已下架(<b>0</b>) </span> </a> </li> 
...
<div class="table-header"> Results for "Latest Registered Domains" </div>
        ...
        <div class="studybox studypad margintop10"> 
         ...
         <a href="http://ued.E岸通.com/dhsurvey/index.php?
             ...
             <div class="noshade-pop-inner"> 
              <div class="list"> 
               <ul> 
                ...
                <li class="mm"> <a href="http://seller.E岸通.com/frttemplate/pageload.do?
