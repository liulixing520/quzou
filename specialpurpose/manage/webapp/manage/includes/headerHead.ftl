...
<head>
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8"/>
    ...
    <title><#if title?has_content>${title}<#elseif titleProperty?has_content>${uiLabelMap.get(titleProperty)}</#if><#if productStore?has_content> - ${productStore.storeName}</#if></title>
