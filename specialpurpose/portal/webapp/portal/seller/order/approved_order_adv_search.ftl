...
<div class="pageContent">
   ...
   <form action="FindApprovedOrder" name='FindApprovedOrderdiv'  id='FindApprovedOrderdiv' method="post"  class="single_table" >
   ...
   <tr class='background_tr'>
    ...
    <tr class='background_tr'>
	<input name='orderStatusId' type='hidden' value='ORDER_APPROVED'>
    <tr class='background_tr'>
...
<div class="formBar">
<ul>
				<li><a  href="#" onclick="javascript:submitForm('FindApprovedOrderdiv');" class="button"><span>${uiLabelMap.CommonFind}</span></a></li>
