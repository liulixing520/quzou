...
cd %OFBIZ_HOME%
echo on
"%JAVA_HOME%\bin\java" -Xms128M -Xmx1024M -XX:MaxPermSize=512m -Xdebug -Xnoagent -Djava.compiler=NONE -Xrunjdwp:transport=dt_socket,server=y,suspend=n,address=5005 -Dfile.encoding=UTF-8 -Dsolr.solr.home=specialpurpose/solr -jar ofbiz.jar
echo off
