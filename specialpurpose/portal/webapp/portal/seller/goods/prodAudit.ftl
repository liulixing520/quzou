...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <body> 
  ...
  <script type="text/javascript"> 
	 $(function(){ 
		$(".breadcrumb").append("<li class='active'>管理产品</li><li class='active'>待审核的产品</li>")
	});   
</script> 
      ...
      <div id="right"> 
        ...
        <div class="col-sailtips clearfix"> 
         ...
         <div class="rightcol-tip"> 
          <p id="hideTipsBox" class="addheight"> 1.您添加的产品需要通过审核后才能上架交易，审核时间通常在24-28个小时之内，遇特殊情况会稍有延迟，敬请谅解<br /> 2.请核对您添加的产品是否符合<a href="http://edu.E岸通.com/s65201d426c7deedbe040007f010020ec.html" target="_blank" class="lkundeline">E岸通产品发布规则</a>，不符合规则的产品将不能通过审核<br /> 3.现在起您发布的上架产品都能够展示在店铺中了！同时还能设置加载搜索产品，获取更多曝光率！<a href="http://help.E岸通.com/E岸通/sellerhelpcn.php?catid=0303&amp;cate=我的产品&amp;artid=952624E6721930F3E0400A0AD40A6747" target="_blank" class="lkundeline">了解更多</a> </p> 
          <span class="viewticps viewshow " id="viewTips">展开</span> 
         </div> 
        </div>
        <form action="<@ofbizUrl>prodAudit</@ofbizUrl>" method="post"> 
        ...
        <div class="rtab-warp" id="newGuideTarget2"> 
         <ul class="nav nav-tabs" style="padding-top:10px; padding-bottom:10px;"> 
          ...
          <li class="current"> <a href="<@ofbizUrl>prodAudit</@ofbizUrl>"> <span id="auditProductNum"> 待审核(<b>0</b>) </span> </a> </li> 
          ...
          <td class="m-mid"> 
           <div class="mid-warp"> 
            <div class="noshade-pop-content"> 
             ...
             <div class="noshade-pop-inner"> 
              <div class="box1"> 
               <p class="s-margin2">尊敬的商城商户，您好！</p>
               <p class="s-margin2">欢迎您使用“我的商城”！您所发布产品信息由于涉嫌销售禁售产品而未能发布成功，禁售产品不能修改和申诉，建议您直接删除该产品。</p>
            ...
            <div class="noshade-pop-content"> 
             ...
             <div class="noshade-pop-inner"> 
              <div class="box1"> 
               ...
               <p class="s-margin2">品牌列表请参考：<br /><a href="http://policy.TradeEase.com/policy_list.php?catalogno=110307&amp;tab=1#" target="_blank">http://policy.TradeEase.com/policy_list.php?catalogno=110307&amp;tab=1# </a></p>
               <p class="s-margin2">更多规则内容，请参阅E岸通网政策规则频道：<br /><a href="http://policy.E岸通.com/" target="_blank">http://policy.E岸通.com/</a></p> 
            ...
            <div class="noshade-pop-content"> 
             ...
             <div class="noshade-pop-inner"> 
              <div class="box1"> 
               ...
               <p class="s-margin2">重复产品规则请参考：<br /><a href="#">http://policy.TradeEase.com/</a></p>
               <p class="s-margin2">更多规则内容，请参阅商城网政策规则频道：<br /><a href="#" target="_blank">http://policy.TradeEase.com/</a></p>
               <p class="s-margin2">√ 如需查看或修改，请按如下步骤：</p> 
               <p class="s-margin2">1.登陆“我的商城”，查看“我的产品”，点击“未通过审核产品”；</p>
               <p class="s-margin2">2.删除信息或者点击“修改产品信息”对产品信息进行修改。</p> 
           ...
           <div class="mid-warp"> 
            <div class="noshade-pop-content"> 
             ...
             <div class="noshade-pop-inner"> 
              <div class="box1"> 
               <p class="s-margin2">尊敬的E岸通网商户，您好！</p> 
               <p class="s-margin2">欢迎您使用“我的E岸通”！您所发布产品信息内容涉及有关商标相同或包含其产品型号，涉嫌侵犯该商标所有人知识产权。您需要获得商标所有人的授权方可发布。</p> 
