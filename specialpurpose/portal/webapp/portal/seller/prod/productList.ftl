...
<div class="content my_account">
	<h2 class="title" style='font-size:20px'>商品信息</h2>
	<div >
			...
			<table class="searchContent">
				<tr>
					...
					<td>
						...
						<a  class="btn-mini" href="<@ofbizUrl>EditProductEn</@ofbizUrl>">新增</a>
						<a  class="btn-mini" href="javascript:{void(0)}" onClick="inventory()">调整库存</a>
						<a  class="btn-mini" href="javascript:{void(0)}" onClick="updateStateUp()">上架</a>
						<a  class="btn-mini" href="javascript:{void(0)}" onClick="updateStateDown()">下架</a>
					</td>
				</tr>
			</table>
		</form>
   	...
   	<table class="points_table tab_content" cellspacing="0" width="100%">
		<thead>
			<tr class='border-bottom:none;'>
				...
				<th style="text-align:center;">售出数量</th>
		...
		<tbody>
		 <#list productList as product>
		 	<tr>
				...
				<td style="text-align:center;">
					<#if product.salesDiscontinuationDate?has_content> 
						<#if Static["org.ofbiz.base.util.UtilDateTime"].nowTimestamp().before(product.salesDiscontinuationDate)>
							<img src="/portal/seller/images/face.gif"  title='上架' width="16" height="16"/>
						<#else>
							<img src="/portal/seller/images/delete.gif"  title='下架' width="16" height="16"/>
						</#if>
					<#else>
						<img src="/portal/seller/images/face.gif" title='上架' width="16" height="16"/>
					</#if>
				...
				<td >
					<a  title='编辑商品' class="btnEdit" href="<@ofbizUrl>EditProductDetail</@ofbizUrl>?productId=${product.productId?if_exists}"><span>编辑</span></a>
					<a rel='EditProductEn' class="btnEdit" href="#" onclick="show_store('${product.productId}','inventory');return false;"><span>库存</span>
				</td>
				<td>
