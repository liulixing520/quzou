...
function submitFormDisableSubmits(form) {
 ...
 $(function(){ 
		$(".breadcrumb").append("<li class='active'>网站管理</li><li class='active'>超级特卖设置</li><li class='active'>特卖设置列表</li>")
	}); 
</script>
<style type="text/css">
                ...
                <div>  -->
                    <div id="sample-table-2_wrapper" class="dataTables_wrapper form-inline no-footer">
                        <table id="sample-table-2"
                            ...
                            <tbody>
						 		<#if RecomSuperDealCategoryList?has_content>
						        <#list RecomSuperDealCategoryList as rsdclist>
						            <#if rsdclist.productId?has_content>
						            <#assign product = delegator.findOne("Product", {"productId" : rsdclist.productId}, true)>
						            </#if>
                                    <td align="center" style="text-align:center;vertical-align:inherit;">
                                    ${rsdclist.productCategoryId?if_exists}
                                    </td>
                                     <td align="center" style="text-align:center;vertical-align:inherit;">
                                    ${rsdclist.productId?if_exists}
                                    </td>
                                     <td align="center" style="text-align:center;vertical-align:inherit;">
                                    ...
                                    ${product.productNameZh?if_exists}
                                     ...
                                     <a class="red" href="javascript:document.ListProductCategoryBranddeleteLink_${(rsdclist.productId)!}.submit()" title="移除"> <i class="ace-icon fa fa-trash-o bigger-130"></i> </a> 
                                     
                   <form onsubmit="javascript:submitFormDisableSubmits(this)" method="post" name="ListProductCategoryBranddeleteLink_${(rsdclist.productId)!}" action="<@ofbizUrl>removeSuperDealCategory</@ofbizUrl>">
					<input name="productId" value="${(rsdclist.productId)!}" type="hidden">
