...
<div class="detail-page">
   <div class="en-us">
           <div class="ui-breadcrumb"> 
  	        <a rel="nofollow" href="<@ofbizUrl>main</@ofbizUrl>"><font>${uiLabelMap.PortalHome}</font></a> <span class="divider"><font>&gt;${uiLabelMap.PortalCustomerService}</font></span>
           </div>
   </div>
			<#if customerservice?has_content>
			   ${StringUtil.wrapString(customerservice.longHelpInfo?if_exists)}
			</#if>  
</div>
