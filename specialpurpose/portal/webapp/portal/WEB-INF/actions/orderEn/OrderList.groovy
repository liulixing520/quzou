...
import org.ofbiz.iteamgr.order.*;
...
orderIdList =  state.getOrdersIdList(partyId,delegator);
//orderHeaderList = state.getOrders(facilityId, filterDate, delegator);
orderHeaderList = state.getOrdersByOrderIds(orderIdList,facilityId, filterDate, delegator);
