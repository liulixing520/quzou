<#assign actionUrlStr="seller_createDeliveryPostalAddress">
<#if mechMap.postalAddress?has_content>
    <#assign actionUrlStr="seller_updateDeliveryPostalAddress">
</#if>
   <script type="text/javascript">
  	 $(function(){ 
		$(".breadcrumb").append("<li class='active'>账户设置</li><li class='active'>发货地址管理</li>")
	}); 
  </script> 
<div class="screenlet">
    ...
    <div id="screenlet_1_col" class="screenlet-body">
        <form method="post" action="<@ofbizUrl>${actionUrlStr}</@ofbizUrl>" name="editcontactmechform"
            ...
            <input type="hidden" name="contactMechPurposeTypeId" id="contactMechPurposeTypeId" value="SHIP_ORIG_LOCATION">
    ...
    <div class="button-bar">
        ...
        <a href="<@ofbizUrl>seller_listDeliveryAddress</@ofbizUrl>" class="smallSubmit">取消</a>
    </div>
</div>
