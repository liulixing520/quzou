...
productId=(productId!=null)?productId:parameters.productId;
productIndex = request.getAttribute("productIndex");
...
//查询订单数量
orderQuantity = 0;
orderItems = delegator.findByAnd("OrderItem", ["productId" : productId], null, false);
for (orderItem in orderItems) {
	orderQuantity += orderItem.quantity;
}

/*Random rand = new Random();
int  orderQuantity = rand.nextInt(30000);*/

context.productIndex = productIndex;
